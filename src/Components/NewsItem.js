          ...
          <div className="row mx-3">
                <div className="col-md-3 my-4">
                    <div className="card" style={{width: "18rem"}}>
                        <img alt="..." src={imgUrl||"https://images.theconversation.com/files/377569/original/file-20210107-17-q20ja9.jpg?ixlib=rb-1.1.0&rect=278%2C340%2C4644%2C3098&q=45&auto=format&w=926&fit=clip"} className="card-img-top" />
